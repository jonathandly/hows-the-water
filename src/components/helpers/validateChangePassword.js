	...
	if(!values.oldPassword) {
		...
		errors.oldPassword = 'Password needs to be more than 8 characters';
   		...
   		errors.oldPassword = "Password should contain at least one number";
    		...
    		errors.oldPassword = "Password should contain at least one special character";
  	}
  	...
  	if (!values.confirmPassword) {
    		...
    		errors.confirmPassword = "Password should contain at least one special character";
